          ...
          <Fade left duration={2000} delay={200}>
            ...
            <div className="md:w-1/2 px-16">
              ...
              <img
                src={bg_img_about}
                alt=""
                className="rounded-r rounded-3xl"
              />
            </div>
          </Fade>
          ...
          <div className="flex flex-col justify-center items-center h-full pt-20">
            <Fade right duration={2000}>
              ...
              <p className="text-xl">
                ...
                and excellence, we take pride in our dedicated team and
                commitment to meeting the unique needs of our clients.
              </p>
              ...
              <p className="text-xl mt-4">
                ...
                project and discover how our commitment to quality and
                innovation can elevate your operations.
              </p>
            </Fade>
          </div>
        </div>
